...
import com.company.mohammedyakub.data.local.db.dao.BuiltDatesDao;
...
@Database(entities = {Manufacturer.class, ManufacturerItems.class, BuiltDate.class}, version = 1, exportSchema = false)
@TypeConverters(Converters.class)
public abstract class AppDatabase extends RoomDatabase {

    public abstract ManufacturerDao manufacturerDao();
    public abstract ManufacturerItemsDao manufacturerItemDao();
    public abstract BuiltDatesDao builtDatesDao();
}